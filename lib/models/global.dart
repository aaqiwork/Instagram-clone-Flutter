...
final User user = new User('aaqijukex69', AssetImage('lib/assets/my_profile.jpg'), [
  follower1,
  follower2,
  follower3
], [
...
User follower3 = new User('johnCena', AssetImage('lib/assets/their_profile.jpeg'), [], [], [], [], true);
